                ...
                <div className="max-w-md px-4 mx-auto sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                  <div className="lg:py-24">
                    <a href="#" className="inline-flex items-center p-1 pr-2 text-white bg-black rounded-full sm:text-base lg:text-sm xl:text-base hover:text-gray-200">
                      ...
                      <span className="ml-4 text-sm">ราคาพิเศษ</span>
                    ...
                    <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                      <span className="block">Codemunha.com</span>
                      <span className="block pt-3 pb-3 text-transparent bg-clip-text bg-gradient-to-r from-teal-200 to-cyan-400">เว็บไซต์ ทันสมัย ดีไซต์หรู</span>
                    </h1>
